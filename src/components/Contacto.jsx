...
const Contacto = () => {
  ...
  const enviar = async (data) => {
    const contactosRef = collection(db, "contacto");
  ...
  if (confirmacionVisible) {
    return (
      <div className="mt-32">
        <h2 className="main-title text-4xl text-center text-white">Gracias! Nos pondremos en contacto contigo pronto 🤍</h2>
        <p className="text-[#e2e97f] mt-10 text-center  ">Tu ID de contacto es: {contactoId}</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex justify-center items-center mt-20">
      <div className="w-96">
      <img src={process.env.PUBLIC_URL + '/assets/logo--shemekes.png'} alt="Descripción de la imagen" />
      </div>
